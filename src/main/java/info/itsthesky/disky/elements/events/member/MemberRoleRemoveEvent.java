...
public class MemberRoleRemoveEvent extends DiSkyEvent<GuildMemberRoleRemoveEvent> {
    ...
    static {
        register("Role Remove Event", MemberRoleRemoveEvent.class, BukkitMemberRemoveEvent.class,
                ...
                .description("Fired when a member removes roles from another member, it's a log action so event-author returns who made the action" +
                        "event-roles returns a list of removed roles")
