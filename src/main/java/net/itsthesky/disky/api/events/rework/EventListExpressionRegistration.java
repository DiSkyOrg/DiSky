...
class EventListExpressionRegistration<T extends Event, E> {
     ...
     */
    EventListExpressionRegistration(String pattern, Class<E> expressionClass, Function<T, E[]> expressionMapper) {
