...
@AllArgsConstructor
@NoArgsConstructor
public class TextDisplayBuilder implements IContainerComponentBuilder<TextDisplay>, ISectionComponentBuilder<TextDisplay> {
    ...
    @Override
    public void loadFrom(TextDisplay component) {
        this.text = component.getContent();
