...
@Description({"Retrieve a specific invite from a guild using its invite code/ID."})
@Examples({"retrieve invite with id \"abc123\" from event-guild and store it in {_invite}"})
@Since("4.0.0")
