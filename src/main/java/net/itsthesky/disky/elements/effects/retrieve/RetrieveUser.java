...
@Name("Retrieve User")
@Description({"Retrieve a Discord user using their unique ID.", "Unlike members, users are global across all guilds."})
@Examples({"retrieve user with id \"000000000000000000\" and store it in {_user}"})
@Since("4.0.0")
