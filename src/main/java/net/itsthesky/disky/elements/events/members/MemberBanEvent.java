...
@Name("Member Ban Event")
@Description({"Fired when a member is banned from a guild.",
        "Provides access to the banned user, the guild, the bot, and the member who performed the ban."})
@Examples({"on member banned:",
